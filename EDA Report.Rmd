...
FYCounciling_Smote <- smotefamily::SMOTE(
  X = FYCouncilingTrain3,
  target = FYCouncilingTrain3$MNHLTH53,
  K = 5,
  dup_size = 2
)
...
smote_class <- predict(FYCounciling_Smote_RF, newdata = FYCouncilingTest3, type = "class")
con_matrix <- table(smote_class, FYCouncilingTest3$MNHLTH53)

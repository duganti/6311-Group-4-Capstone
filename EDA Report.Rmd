...
```{r}
#Range of Young Men Aged 18-25 visual.
...
```{r}
#Average mean, median, and sd of mental health status per age.
...
```{r}
#Continuous variable table involving skewness, kurtosis, sd, median, mean, minimum and maximum.
